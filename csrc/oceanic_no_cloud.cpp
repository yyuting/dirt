...
class OceanicNoCloudOpGpu : public OpKernel
{
...
public:
    ...
    explicit OceanicNoCloudOpGpu(OpKernelConstruction* context) :
    ...
    void Compute(OpKernelContext* context) override
    {
        ...
        get_gl_dispatcher().dispatch(hwc, [&](PerThreadObjects &objects) {
            ...
            GLuint const tri_fragment_shader = gl_common::create_shader(shaders::oceanic_no_cloud);
...
REGISTER_KERNEL_BUILDER(Name("OceanicNoCloud").Device(DEVICE_GPU), OceanicNoCloudOpGpu);
